...
/* Specify the reaction to an EPIPE error during the closing of stdout:
   ...
   child process, it usally is a bug in the parent process: It is bad
   pratice to have SIGPIPE ignored or blocked while creating a child process.
   ...
   pipe reader and should lead to a diagnostic and nonzero exit status.
...
/* Close standard output. On error, issue a diagnostic and _exit
   ...
   because the behaviour is undefined if 'exit' is called more than
