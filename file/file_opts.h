/* Table of command-line options 
   ...
   The third column specifies whether if takes a paramenter.
   The fourth column is the documentation.

   N.B. The long options' order must correspond to the code in file.c,
   and OPTSTRINGS must be kept up-to-date with the short options.
...
OPT('c', "checking-printout", 0,"       print the parsed form of the magic files, use in\n"
